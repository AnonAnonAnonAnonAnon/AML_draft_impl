...
AGENT_API_KEY = "sk-c0sBK7t2p6LV84r5s7KUknm4BvzcEdiwjd3jRNE1IdV0Ero5"  # 填你的 UIUI Key
...
if __name__ == "__main__":
    ...
    # user_query = "你好，用一句话说明你能做什么。以及，尝试调用codex工具，say hello看看能不能通"
    user_query = "你好，用一句话说明你能做什么。也尝试调用下rag工具，看看能不能调，有没有什么返回。是agent的工具rag_search，这里先不需要调用codex"
