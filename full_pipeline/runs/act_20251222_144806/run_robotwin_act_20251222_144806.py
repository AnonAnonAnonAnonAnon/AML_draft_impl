...
def main():
    ...
    run(["bash", str((repo_root / "full_pipeline/runs/act_20251222_144806/process_act_20251222_144806.sh").resolve()),
         args.task_name, args.task_config, str(args.expert_data_num)], cwd=act_dir)

    # 3) train (cwd=policy/ACT)
    run(["bash", str((repo_root / "full_pipeline/runs/act_20251222_144806/train_act_20251222_144806.sh").resolve()),
    ...
    run(["bash", str((repo_root / "full_pipeline/runs/act_20251222_144806/eval_act_20251222_144806.sh").resolve()),
